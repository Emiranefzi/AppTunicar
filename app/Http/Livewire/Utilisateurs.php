...
class Utilisateurs extends Component
{
    ...
    public function rules(){
        if($this->currentPage == PAGEEDITFORM){
            ...
            return [
                ...
                'editUser.dateNaissance' => 'required',
                'editUser.tel' => ['required', 'numeric', Rule::unique("users", "tel")->ignore($this->editUser['id']) ]  ,
                'editUser.ville' => ['required'],
                'editUser.cin' => ['required', Rule::unique("users", "cin")->ignore($this->editUser['id']) ],
        ...
        return [
            ...
            'newUser.dateNaissance'=> 'required',
            'newUser.tel' => 'required|numeric|unique:users,tel',
            'newUser.ville'=> 'required',
            'newUser.cin'=> 'required|unique:users,cin',
    ...
    public function updateRoleAndPermissions(){
        ...
        $this->dispatchBrowserEvent("showSuccessMessage", ["message"=>"Roles et permissions mises à jour avec succès!"]);
    }
