            ...
            <form role="form" wire:submit.prevent="addClient()" method="POST">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('addClient.email') is-invalid @enderror"
                    ...
                    <div class="d-flex">
                        <div class="form-group flex-grow-1 mr-2">
                            ...
                            <input type="number" class="form-control @error('addClient.tel') is-invalid @enderror"
                                wire:model="addClient.tel">
                            @error('addClient.tel')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number"
                            class="form-control @error('addClient.cin') is-invalid @enderror"
                            wire:model="addClient.cin">
                        @error('addClient.cin')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
